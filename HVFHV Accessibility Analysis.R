...
loc = "H:/[1] FHV Accessibility/Research Projects/A Look into For Hire Vehicles Accessibility"
setwd(loc)
...
df_june_2019 <- read.csv(file="H:/[1] FHV Accessibility/Research Projects/A Look into For Hire Vehicles Accessibility/Data/2019-06_FHV_WAVs_on_the_road_2019-09-11_v01.csv", header=TRUE, sep=",")
df_june_2018 <- read.csv(file="H:/[1] FHV Accessibility/Research Projects/A Look into For Hire Vehicles Accessibility/Data/2018-06_FHV_WAVs_on_the_road_2019-09-11_v01.csv", header=TRUE, sep=",") 
...
shape_files_2 <- "H:/[1] FHV Accessibility/High-Volume/Plots/Shape Files 2"
...
# Save map as png
ggsave(june_2019,
       filename = ("H:/[1] FHV Accessibility/Research Projects/A Look into For Hire Vehicles Accessibility/Plots/June_2019.png"),
       width = 15,
       height = 10,
       dpi = 300)
...
# Save map as png
ggsave(june_2018,
       filename = ("H:/[1] FHV Accessibility/Research Projects/A Look into For Hire Vehicles Accessibility/Plots/June_2018.png"),
       width = 15,
       height = 10,
       dpi = 300)